...
function App() {
  return (
    <NavigationContainer>
       ...
       <Stack.Screen name="SplashScreen" options={{headerShown:false,statusBarColor:'#f8fbff'}} component={SplashScreen} />
       <Stack.Screen name="GreetScreen" options={{headerShown:false,statusBarColor:'#f8fbff'}} component={GreetScreen}/>
       ...
       <Stack.Screen name="QRScannerPage" component={QRScannerPage} options={{
        ...
        <Stack.Screen name="ScannedDataScreen" options={{
          headerTitle:'Pay',
          headerBackTitle:'QR'
